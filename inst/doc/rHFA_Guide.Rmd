...
arguments in `rHFA` functions: - YEAR (*factor*): `year` instance of
data collection - likley year. - COMPANY (*factor*): `popn`
differentiates subpopulations within the dataset. In this case, company
that entered the hybrid. - HYBRID (*factor*): `geno` Hybrid (genotype)
identifier. - IS_CHECK: Unique to this dataset. Flag for whether a line
is a "check" line - i.e. grown in all locations in a given year. - SITE
(*factor*): `site`, the location of data collection. - YIELD
(*numeric*):`pheno`, the phenotype of interest. Here, a hybrid's average
yield across replicates within the site-year
...
FIX THIS STATEMENT  ---->
r round(ss['is_home', 'pct Var'], 2) % of total
variance. Not much.
