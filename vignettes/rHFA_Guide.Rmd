...
% increase over
the average corn yield in this dataset. However, this was about 1.3 bushels 
per acre less than expected (90% confidence interval: -2.2 to -0.2 bushels 
per acre). Every permutation's HFA was larger than the observed HFA (*p* = 0), 
which you can verify by looking at the permutations themselves:
